...
public class TinyDB {
    ...
    public ArrayList<UrlItem> getListObject(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<UrlItem> objects =  new ArrayList<UrlItem>();

    	for(String jObjString : objStrings){
    		UrlItem value  = gson.fromJson(jObjString,  UrlItem.class);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<UrlItem> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(UrlItem obj : objArray){
